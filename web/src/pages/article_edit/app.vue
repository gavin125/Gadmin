  ...
  <div class="xggWrap">
    ...
    <div class="xggMain bg-white pb-2 border-left border-bottom">
      ...
      <div class="container-fluid">
        <h3 class="border-bottom pb-2 mb-4 text-secondary">{{items[items.length-1].text}} <a href="article.html" class="btn btn-success btn-sm float-right">返回列表</a></h3>
    ...
    return {
      ...
      menu:[
        ...
        [{
          ...
          text:'文章列表',link:'article.html',active:true
        }],
        [{
